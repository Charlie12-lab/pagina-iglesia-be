        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChurchName = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PastorName = table.Column<string>(type: "text", nullable: true),
                    PastorEmail = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowsRegistration = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Church = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: true),
                    VoucherPath = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    GroupId = table.Column<string>(type: "character varying(36)", maxLength: 36, nullable: true),
